...
#### Gini index overall and by fuel type
```{r tidy=TRUE}
...
#### Plot Gini by fuel type and sector
...
### Lorenz Asymmetry Coefficient Calculations: CO2 and GDP
...
### plot all (CO2/GDP, Sector and Fuel Type)
```{r fig.height = 4.5, fig.width = 7, fig.align = "center"}
